...
void OverworldHandler::do_action(OverworldModel *overworldModel, string action){
    ...
    if (action == "Battle") {
        ...
        unsigned int xp = this->logicWrapper->gameLogic->deligate_post_battle_xp(overworldModel);
        unsigned int money = this->logicWrapper->gameLogic->deligate_post_battle_money(overworldModel);
