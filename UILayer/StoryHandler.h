...
string pre_intro = "The year is 2089..";

string intro_content_1 = R"(
...
string elon_atmo_2 = "(He gestures, activating an energy blade at his wrist.)";

// Phase 2
string elon_atmo_3 = "(Elontron stumbles back, his body failing. He chuckles—distorted, digital, inhuman.)";
string elon_dialoge_2 = "Did you really think you were fighting me? Flesh is a liability. I left that behind long ago.";

string elon_atmo_4 = R"(
